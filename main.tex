...
\subsection{Алгоритм выбора экземпляров класса Monad}\label{filtermonad}
...
\subsection{Алгоритм генерации экземпляров классов Applicative и Functor}\label{generation}
...
\subsection{Алгоритм формирование выходного файла}
